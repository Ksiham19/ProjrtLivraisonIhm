...
function AjouterNouveauLivreur() {
    ...
    return (
        <div className="custom-form-wrapper">
            ...
            <form onSubmit={handleSubmit} className="custom-form">
                ...
                <div className="custom-input-box">
                    <div className="custom-input-field">
                        <input type="text" id="prenom" placeholder="Prénom" value={formData.prenom} onChange={handleChange} />
...
export default AjouterNouveauLivreur;
